                ...
                <div class="section" id="maintenance">
                    ...
                    <div class="section-body">
                        <div class="stat-grid">
                            ...
                            ${(m.aggressive_vacuum_count || 0) > 0 ? `<div class="stat-card"><div class="stat-value">${m.aggressive_vacuum_count}</div><div class="stat-label">Aggressive (anti-wraparound)</div></div>` : ''}
